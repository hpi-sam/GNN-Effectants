...
#    elif dataset_str == 'mumps':
#
#        graphs = []
#        features = []
#        with open('data/data_mumps.txt', 'rb') as f:
...
#        # graphs.append(graph)
        ...
        label_all = np.loadtxt('data/labels_mumps_test.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
    ...
    elif dataset_str == 'emesis':

        with open('data/data_emesis.txt', 'rb') as f:
            graph = nx.read_edgelist(f)

        label_all = np.loadtxt('data/labels_emesis_final.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
    ...
    elif dataset_str == 'bleeding':

        with open('data/data_Bleeding.txt', 'rb') as f:
            graph = nx.read_edgelist(f)

        label_all = np.loadtxt('data/labels_Bleeding_final.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
    ...
    elif dataset_str == 'body_temp':

        with open('data/data_body_temp.txt', 'rb') as f:
            graph = nx.read_edgelist(f)

        label_all = np.loadtxt('data/labels_body_temp_final.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
    ...
    elif dataset_str == 'coccydynia':

        with open('data/data_coccydynia.txt', 'rb') as f:
            graph = nx.read_edgelist(f)

        label_all = np.loadtxt('data/labels_coccydynia_final.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
    ...
    elif dataset_str == 'carbuncle':

        with open('data/data_carbuncle.txt', 'rb') as f:
            graph = nx.read_edgelist(f)

        label_all = np.loadtxt('data/labels_carbuncle_final.txt')
        graph_label_all = label_all.copy()
        graph_label_all[:,1] = graph_label_all[:,1]#//6
