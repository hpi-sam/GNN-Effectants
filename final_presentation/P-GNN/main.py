            ...
            for epoch in range(args.epoch_num):
                ...
                if epoch % args.epoch_log == 0:
                    ...
                    for id, data in enumerate(data_list):
                        ...
                        pr_train += average_precision_score(label.flatten().cpu().numpy(), out_act(pred).flatten().data.cpu().numpy())
                        ...
                        pr_val += average_precision_score(label.flatten().cpu().numpy(), out_act(pred).flatten().data.cpu().numpy())
                        ...
                        pr_test += average_precision_score(label.flatten().cpu().numpy(), out_act(pred).flatten().data.cpu().numpy())
                    ...
                    print(repeat, epoch, 'Loss {:.4f}'.format(loss_train), 'Train AUC: {:.4f}'.format(auc_train),
                          'Val AUC: {:.4f}'.format(auc_val), 'Test AUC: {:.4f}'.format(auc_test), 'Train PR: {:.4f}'.format(pr_train),
                          'Val PR: {:.4f}'.format(pr_val), 'Test PR: {:.4f}'.format(pr_test))
                    writer_train.add_scalar('repeat_' + str(repeat) + '/auc_'+dataset_name, auc_train, epoch)
                    writer_train.add_scalar('repeat_' + str(repeat) + '/pr_'+dataset_name, pr_train, epoch)
                    ...
                    writer_val.add_scalar('repeat_' + str(repeat) + '/pr_'+dataset_name, pr_val, epoch)
                    ...
                    writer_test.add_scalar('repeat_' + str(repeat) + '/pr_'+dataset_name, pr_test, epoch)
